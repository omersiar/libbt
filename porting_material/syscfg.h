...
#define MYNEWT_VAL_BLE_MAX_CONNECTIONS (4) //SEB e.g. max 1 connection to the studio + 3 beacons
#endif
...
#define MYNEWT_VAL_BLE_L2CAP_COC_MAX_NUM (3) //SEB 1 only is not enough because it seems to be taken by the GATT protocol
#endif

#ifndef MYNEWT_VAL_BLE_L2CAP_COC_MTU //SEB
...
#define MYNEWT_VAL_BLE_SM_LEGACY (0) //SEB was 1
#endif
...
//SEB for the DIS service
#define MYNEWT_VAL_BLE_SVC_DIS_DEFAULT_READ_PERM				BLE_GATT_CHR_F_READ_AUTHOR
#define MYNEWT_VAL_BLE_SVC_DIS_MODEL_NUMBER_READ_PERM			MYNEWT_VAL_BLE_SVC_DIS_DEFAULT_READ_PERM
#define MYNEWT_VAL_BLE_SVC_DIS_MODEL_NUMBER_DEFAULT				NULL
